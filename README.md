...
This code is protected under the NASA Open Source Agreement (v1.3) [see below], which is actually a pretty liberal license.

Why would I go through the effort of stripping coordinate conversion out of World Wind?

Because the license is far more liberal than the other open source coordinate conversion libraries on the web (especially those that have MGRS - which is what I really need).
